...
docker buildx build --push --platform linux/amd64,linux/arm64 --tag quay.io/marcelosales/api-app:0.0.6 -f docker/Dockerfile.nginx .
```
...
### AMD64
```
docker build --tag quay.io/marcelosales/api-app:0.0.5 -f docker/Dockerfile.nginx .
```