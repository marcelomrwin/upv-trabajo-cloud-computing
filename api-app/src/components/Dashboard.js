                    ...
                    <Accordion.Body className="text-start">
                        <Accordion defaultActiveKey={['0']} flush alwaysOpen>
                                ...
                                <Accordion.Body>
                                    ...
                                    <li>Has integration with Kafka for:
                                        <ul>
                                            ...
                                            <li>To receive notifications regarding metrics generated by the <b>Observer</b> component
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                            ...
                            <Accordion.Item eventKey="2">
                                ...
                                <Accordion.Body>
                                    <h4>Work Executor</h4>
                                    <h5>Responsible for the execution of the work. Generates the publication of a news</h5>
                                    <hr/>
                                    <li>Developed with <a href="https://quarkus.io/">Quarkus</a> 2.14</li>
                                    <li>Has integration with Kafka for:
                                        <ul>
                                            <li>Receive notifications of recent news and save in the local base for future processing</li>
                                    ...
                                    <li>Uses <a href="https://redis.io/">Redis</a> as distributed cache integrated with <b>Observer</b> and <b>Injector</b> components</li>
                                    <li>Integrates with <a href="https://min.io/"><b>MIN</b>IO</a> to obtain files</li>
                                    <li>Performs integration with GitHub to obtain a python script responsible for executing the work
                                        <ul><li>Validates the necessary tag in the configuration file, if the repository has already been cloned, it does not perform the action again.</li></ul>
                                    </li>
                                    <li>Prepare the entire environment with the necessary variables to delegate execution to the python script</li>
                                    <li>Makes use of the <i>imagemagick</i> feature to manipulate images during news publication</li>
                                    <li>Upon receiving the news publication request <i>(Job Request)</i>, the Executor obtains the metadata as follows:
                                    <ol>
                                        <li>First do a search in the Redis cache</li>
                                        <li>Then search its local base</li>
                                        <li>Finally, if it does not find it, it makes a remote call to the <b>Injector</b> component requesting the data</li>
                                    </ol>
                                    </li>
                                    <li>Makes use of <a href="https://quarkus.io/guides/smallrye-fault-tolerance#adding-resiliency-retries">retries</a>, <a href="https://quarkus.io/guides/smallrye-fault-tolerance#adding-resiliency-circuit-breaker">circuit breaker</a>, <a href="https://quarkus.io/guides/smallrye-fault-tolerance#adding-resiliency-fallbacks">fallback</a> and <a href="https://quarkus.io/guides/smallrye-fault-tolerance#adding-resiliency-timeouts">timeouts</a> techniques</li>
