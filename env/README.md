...
```shell
docker-compose -f docker-compose-confluent.yaml down && docker-compose -f docker-compose-confluent.yaml pull && docker-compose -f docker-compose-confluent.yaml up
```